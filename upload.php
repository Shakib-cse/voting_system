    ...
    <div class="container">
        ...
        <header>
            <div class="logo-container">
                <!-- SVG Pencil / Comic Icon -->
                <svg width="48" height="48" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style="transform: rotate(-10deg);">
                    <path d="M13.5 6L18 10.5M19.5 9L15 4.5M3 17.25V21H6.75L17.81 9.94L14.06 6.19L3 17.25Z" stroke="#1a1a1a" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
                <div>
